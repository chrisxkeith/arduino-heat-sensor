...
# 5 "C:\\Users\\chris\\Documents\\Github\\arduino-heat-sensor\\arduino-heat-sensor.ino" 2
...
U8G2_SSD1327_EA_W128128_F_HW_I2C u8g2((&u8g2_cb_r0), 255);
...
# 67 "C:\\Users\\chris\\Documents\\Github\\arduino-heat-sensor\\arduino-heat-sensor.ino" 2
# 68 "C:\\Users\\chris\\Documents\\Github\\arduino-heat-sensor\\arduino-heat-sensor.ino" 2


# 69 "C:\\Users\\chris\\Documents\\Github\\arduino-heat-sensor\\arduino-heat-sensor.ino"
class Sensor {
  private:
    int lastVal;
  protected:
  ...
  public:
    Sensor(int pin, String name, double factor) {
        ...
        this->factor = factor;
        this->lastVal = 
# 82 "C:\\Users\\chris\\Documents\\Github\\arduino-heat-sensor\\arduino-heat-sensor.ino" 3 4
                       (-0x7fffffff - 1)
# 82 "C:\\Users\\chris\\Documents\\Github\\arduino-heat-sensor\\arduino-heat-sensor.ino"
                              ;
        pinMode(pin, (0x00));
    }
    ...
    void sample() {
        if (pin >= ap3_analog_A0 && pin <= ap3_analog_A5) {
...
Sensor thermistorSensor(ap3_analog_A0, "Stove", 0.036);

class GridEyeSupport {
public:
  GridEYE grideye;
  int mostRecentValue = 
# 110 "C:\\Users\\chris\\Documents\\Github\\arduino-heat-sensor\\arduino-heat-sensor.ino" 3 4
                           (-0x7fffffff - 1)
# 110 "C:\\Users\\chris\\Documents\\Github\\arduino-heat-sensor\\arduino-heat-sensor.ino"
                                  ;
